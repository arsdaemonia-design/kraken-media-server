...
content = content.replace(old_desktop_action, new_desktop_action, 1)
...
content = content.replace(old_desktop_sort, new_desktop_sort, 1)
...
content = content.replace(old_mobile_action, new_mobile_action, 1)
...
content = content.replace(old_mobile_sort, new_mobile_sort, 1)

# 3. Sidebar Config Row
...
content = content.replace(old_sidebar_top, new_sidebar_top, 1)

# 4. Remove Desktop Views
...
content = content.replace(old_desktop_views, "", 1)

# 5. Remove Mobile Views
...
content = content.replace(old_mobile_views, """                        <div class="flex-1"></div>""", 1)

# 6. Global persistent logo bar
old_view_library = """            <div id="view-library" class="animate-fade-in pb-32">
                <div class="mb-3 md:mb-4">
                    <!-- Botón para expandir estadísticas en móvil -->"""
new_view_library = """            <div id="view-library" class="animate-fade-in pb-32">
            ...
            <div class="w-full bg-[#0a0a0a]/95 backdrop-blur-xl border-b border-emerald-900/30 flex items-center justify-between px-4 py-2 z-50 sticky top-0 shadow-lg shrink-0 mb-3">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 select-none group">
                        ...
                        <h1 class="text-sm font-black tracking-[0.2em] text-metal leading-none font-sans mt-0.5 hidden sm:block">
                ...
                <div class="mb-3 md:mb-4">
                    <!-- Botón para expandir estadísticas en móvil -->"""
content = content.replace(old_view_library, new_view_library, 1)

# 7. Remove logos from headers
...
content = content.replace(old_desktop_logo, "", 1)
...
content = content.replace(old_mobile_logo, "", 1)

# 8. Add Console next to Explorador
...
content = content.replace(old_explorador, new_explorador, 1)
